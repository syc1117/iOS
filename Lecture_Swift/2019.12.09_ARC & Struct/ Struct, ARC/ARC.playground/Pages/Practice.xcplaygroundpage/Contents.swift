...
final class MemoryViewController: UIViewController {
  ...
  var person: Person? = Person(name: "James")  //person rc +1
  var apartment: Apartment? = Apartment(unit: "3A") // Apartment rc +1
...
var memoryVC: MemoryViewController? = MemoryViewController() //p 1, a 1
memoryVC?.loadClass() //
memoryVC = nil
