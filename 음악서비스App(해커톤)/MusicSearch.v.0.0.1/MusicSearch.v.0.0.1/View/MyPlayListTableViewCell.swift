...
class MyPlayTableViewCell: UITableViewCell {
...
//        likeButton.setBackgroundImage(UIImage(named: "fullheart"), for: .normal)
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        titleLabel.layout.trailing( constant: -10).leading(equalTo: imgView.trailingAnchor, constant: 10).centerY(equalTo: contentView.centerYAnchor, constant: -10)
